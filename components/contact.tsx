    ...
    >
      ...
      <div
        ...
        >I am open for consulting roles, as well as to any REMOTE part-time or full-time opportunity. You can email me anytime at{' '}
          ...
          <span className='font-semibold italic'>{'+1 (503) 807-3270.'}</span>
        </p>
      </div>
      <form
      ...
      >
        ...
        />
        <textarea
          className='h-52 rounded-lg my-3 borderBlack p-4 dark:bg-white dark:bg-opacity-80 dark:focus:bg-opacity-100 transition-all dark:outline-none'
          name='message'
