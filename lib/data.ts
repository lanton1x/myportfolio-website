...
import { SiTestcafe, SiAmazonwebservices, SiNextdotjs } from 'react-icons/si'; // Fixed imports
import { MdRateReview } from 'react-icons/md'; // Alternative for SiCodereview
...
export const experiencesData = [
  ...
  },
  {
    ...
    icon: React.createElement(SiAmazonwebservices), // Fixed: SiAmazonaws → SiAmazonwebservices
    date: '2021 - 2022',
  },
  {
    title: 'Entrepreneur',
  ...
  },
  {
    ...
    icon: React.createElement(MdRateReview), // Fixed: SiCodereview → MdRateReview
    date: '2022 - present',
  },
  {
